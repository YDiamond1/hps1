//
// Created by YDiamond on 02.10.2021.
//

#include <malloc.h>
#include "alg_smooth.h"

static void print_mas(int *mas, int size){
...
void smooth_sort(sorteddatatype A[], int num) {
    heapsizes hsz;
